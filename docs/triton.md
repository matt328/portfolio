...
Triton will someday be a Vulkan game engine written in C++. It features a modern C++ development environment as well as general programming patterns I tend to reach for regardless of which ecosystem I find myself in.
...
- CMake - for cross platform C++ projects, CMake abstracts a lot of tedious platform specific configuration and using FetchContent, provides a clean and simple way to manage dependencies.
...
- Jetbrains CLion - I also use CLion from time to time, as everything just works out of the box, and sometimes I don't feel like tinkering with tools and just writing code.
...
- Tracy Profiler - I've instrumented most of the lower level rendering code with Tracy's client markup, and this has been critical in troubleshooting issues with rendering and multithreading, and just keeping an eye on how things are performing.
- Renderdoc - this tool is great for troubleshooting and debugging shader and graphics pipeline issues in genera.
